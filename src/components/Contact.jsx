    ...
    <div>
      <div>
        <section className="bg-gray-100 dark:bg-gray-900">
          <div className="py-1 lg:py-4 px-4 mx-auto max-w-screen-md">
        ...
        <div className="container max-w-screen-xl mx-auto px-4">
          ...
          <div className="text-center">
            <div className="flex justify-center mb-8">
              <img src="./assets/image/home-img.png" alt="Image1" />
            </div>
            ...
            <a className="px-7 py-3 md:px-9 md:py-4 font-medium md:font-semibold bg-gray-700 text-gray-50 text-sm rounded-md hover:bg-gray-50 hover:text-gray-700 transition ease-linear duration-500">
              Hire me
            </a>
          </div>
        </div>
        ...
        <div className="container max-w-screen-xl mx-auto px-4">
          <div className="text-center">
            ...
            <p className="font-medium text-gray-700 text-xs md:text-base">
              ...
              projects and @vuejs for front-end projects. I’m an avid
              programmer, so I create designs based on the weekend @figmadesign.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 md:py-16">
        <div className="container max-w-screen-xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            <img src="./assets/image/brand-1.png" alt="Image3" />

            <img src="./assets/image/brand-2.png" alt="Image4" />

            <img src="./assets/image/brand-3.png" alt="Image5" />

            <img src="./assets/image/brand-4.png" alt="Image6" />

            <img src="./assets/image/brand-5.png" alt="Image7" />

            <img src="./assets/image/brand-6.png" alt="Image8" />
          </div>
        </div>
      </section>
